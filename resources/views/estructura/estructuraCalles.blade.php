...
<div class="col-md-12">
    <div class="card card-user">
      <div class="card-header">
        <h5 class="card-title">Cargar Estructura de Calles</h5>
      </div>
      <div class="card-body">
        <form method="post" action="{{ route('estructura.store') }}">
          ...
          <div class="row">
            <div class="col-md-12">
              <a href="{{ route('estructura.estructuraCallesPdf') }}" class="btn btn-primary btn-round" target="_blank">Generar PDF</a>  
            <div class="card">
            <div class="col-md-12">
            <div class="card">
              <div class="card-body">
