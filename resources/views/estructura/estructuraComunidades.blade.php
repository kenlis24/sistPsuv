...
<div class="col-md-12">
    <div class="card card-user">
      <div class="card-header">
        <h5 class="card-title">Cargar Estructura de Comunidades</h5>
      </div>
      <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="hidden" name="est_nivel" id="est_nivel" value="comunidades"/>         
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" name="est_nivel_id"  name="est_car_id" id="comunSelect" required>
                      ...
                      @foreach ($estructuras as $item)  
                            <tr>
                                ...
                                <td class="text-right">   
                                  ...
                                  <form class="miFormulario" action="{{ route('estructura.destroy',['id' => $item->id,'pag' => 'comunidades']) }}">
                                    @method("DELETE")
                                      @csrf
