...
<div class="col-md-12">
    <div class="card card-user">
      <div class="card-header">
        <h5 class="card-title">Cargar Estructura de Comunidades JPSUV</h5>
      </div>
      <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="hidden" name="estj_nivel" id="estj_nivel" value="comunidades"/>         
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" name="estj_nivel_id"  name="estj_car_id" id="comunSelect" required>
                      ...
                      @foreach ($jpsuv_estructuras as $item)  
                            <tr>
                                ...
                                <td class="text-right">   
                                  ...
                                  <form class="miFormulario" action="{{ route('jpsuvEstructura.destroy',['id' => $item->id,'pag' => 'comunidades']) }}">
                                    @method("DELETE")
                                      @csrf
