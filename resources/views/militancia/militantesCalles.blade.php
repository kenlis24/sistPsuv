...
<div class="col-md-12">
    <div class="card card-user">
      <div class="card-header">
        <h5 class="card-title">Cargar Asistencia de Calles</h5>
      </div>
      <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="hidden" name="mil_tipo_nivel" id="mil_tipo_nivel" value="calles"/>
...
<script>
  ...
  function consultarLista()
  {
    ...
    var calle = document.getElementById("calleSelect").value;
    var pag = 'calles';
    
    fetch(`tableMilitancia/${calle}/${fecha}/${evento}/${pag}/militanciaUBCH`)
      .then( function (response) { 
        return response.json();       
